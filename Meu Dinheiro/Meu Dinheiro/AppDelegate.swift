...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        let calendar = tabBar.items?[1]
        let category = tabBar.items?[2]
        
        home?.title = "Home"
        home?.image = UIImage(named: "home")
        
        calendar?.title = "Meses"
        calendar?.image = UIImage(named: "calendar")
        
        category?.title = "Categorias"
        category?.image = UIImage(named: "category")
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "Meu_Dinheiro")
